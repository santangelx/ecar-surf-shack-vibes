          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-ocean-dark">{t('openingTimes')}</h3>
              </div>
              <div className="space-y-4">
                <div className="text-center p-6 bg-ocean-light/10 rounded-lg">
                  <p className="text-lg font-semibold text-ocean-dark">{t('seasonInfo')}</p>
                  <p className="text-gray-600 mt-2">10:00 AM - 8:00 PM</p>
                </div>
              </div>
            </div>
